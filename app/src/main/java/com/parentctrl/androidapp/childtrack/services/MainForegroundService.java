package com.parentctrl.androidapp.childtrack.services;
...
import com.parentctrl.androidapp.childtrack.activities.BlockedAppActivity;
import com.parentctrl.androidapp.childtrack.activities.ChildSignedInActivity;
import com.parentctrl.androidapp.childtrack.broadcasts.AppInstalledReceiver;
import com.parentctrl.androidapp.childtrack.broadcasts.AppRemovedReceiver;
import com.parentctrl.androidapp.childtrack.broadcasts.PhoneStateReceiver;
import com.parentctrl.androidapp.childtrack.broadcasts.ScreenTimeReceiver;
import com.parentctrl.androidapp.childtrack.broadcasts.SmsReceiver;
import com.parentctrl.androidapp.childtrack.models.App;
import com.parentctrl.androidapp.childtrack.models.Child;
import com.parentctrl.androidapp.childtrack.models.Contact;
...
import static com.parentctrl.androidapp.childtrack.NotificationChannelCreator.CHANNEL_ID;
...
public class MainForegroundService extends Service {
	...
	public static final String BLOCKED_APP_NAME_EXTRA = "com.parentctrl.androidapp.childtrack.services.BLOCKED_APP_NAME_EXTRA";
	...
	private void setFence(DataSnapshot dataSnapshot) {
		final com.parentctrl.androidapp.childtrack.models.Location childLocation = dataSnapshot.getValue(com.parentctrl.androidapp.childtrack.models.Location.class);
	...
	private String getLollipopForegroundAppPackageName() {
		...
		try {
			...
			for (UsageStats stats : foregroundApps) {
                /*if (i == 0 && !"com.parentctrl.androidapp.childtrack".equals(stats.getPackageName())) {
